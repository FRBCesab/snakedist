...
- `adour_sites_coords`: a table (`csv`) containing spatial coordinates of 10 locations sampled along the Adour.
...
```{r 'compute-distances', echo=TRUE}
dists <- distance_along(adour_sites, adour_river, density = 0.01, type = "regular", mc.cores = 2)
dists
```
